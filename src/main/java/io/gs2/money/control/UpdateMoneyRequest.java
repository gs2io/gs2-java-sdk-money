...
public class UpdateMoneyRequest extends Gs2BasicRequest<UpdateMoneyRequest> {
	 ...
	 * @return this
	 */
	public UpdateMoneyRequest withEnableFakeReceipt(Boolean enableFakeReceipt) {
	 ...
	 * @return this
	 */
	public UpdateMoneyRequest withFakePlatform(String fakePlatform) {
	 ...
	 * @return this
	 */
	public UpdateMoneyRequest withFakePurchaseItemName(String fakePurchaseItemName) {
